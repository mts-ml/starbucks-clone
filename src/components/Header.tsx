            ...
            <header className="relative z-30 w-full shadow pb-0.5">
                <div className={`${menuPage ? "" : "mx-auto max-w-[95rem]"}`}>
                    <nav aria-label='Main navigation'>
                        ...
                        <div className='relative z-50 flex items-center justify-between my-4 mx-6 xl:mx-0'>
                            <Link to="/">
                                <img
                                    src={logo}
                            ...
                            <button
                                className={`relative w-6 h-6 min803:hidden hover:bg-black/5 hover:rounded-full transition-all duration-200 ease-out hover:scale-105 hover:shadow-sm ${toggleMenu ? "toggle-btn" : ""}`}
                                type="button"
                        ...
                        <div className={`min803:hidden fixed top-[75px] z-20 px-7 pt-14 h-full transition-all duration-1000 ease-in-out bg-white w-4/5 border-t-2 border-black/10  ${toggleMenu ? 'right-0' : '-right-[700px]'}`}>
                        ...
                        <div className={`relative hidden min803:flex min803:items-center justify-between md:m-4 ${menuPage ? "pl-[5.1rem] min1702:pl-[6.1rem] lg:pr-9" : ""}`}>
