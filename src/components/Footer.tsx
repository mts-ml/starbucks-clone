...
export const Footer: React.FC = () => {
   ...
   return (
      <footer className="mt-10 max-w-7xl mx-auto">
         <section className="flex mx-6 max-lgflex-col gap-10 lg:gap-6 font-semibold px-6">
            <div>
               <button
         ...
         <section>
            <ul className="flex gap-4">
               <li><img src={spotifyLogo} width={32} alt="Spotify icon" /></li>
               <li><img src={fbIcon} width={32} alt="Facebook icon" /></li>
               <li></li>
               <li></li>
               <li></li>
               <li></li>
